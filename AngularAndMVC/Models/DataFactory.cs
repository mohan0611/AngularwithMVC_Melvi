    ...
    public static class DataFactory
    {
        public static IEnumerable<CustomerModel> GetCustomers()
        {
            return new List<CustomerModel>()
            {
                ...
                new CustomerModel() { CustomerId = 6, FirstName = "Miguel", LastName = "Castro", Email = "miguelcastro67@gmail.com" },
                new CustomerModel() { CustomerId = 7, FirstName = "John", LastName = "Petersen", Email = "johnvpetersen@gmail.com" },
                new CustomerModel() { CustomerId = 8, FirstName = "Brian", LastName = "Noyes", Email = "briannoyes@gmail.com" },
                new CustomerModel() { CustomerId = 9, FirstName = "Andrew", LastName = "Brust", Email = "andrewbrust@gmail.com" },
                new CustomerModel() { CustomerId = 10, FirstName = "Rocky", LastName = "Lhotka", Email = "rockylhotka@gmail.com" },
                new CustomerModel() { CustomerId = 11, FirstName = "Miguel", LastName = "Castro", Email = "miguelcastro67@gmail.com" },
                new CustomerModel() { CustomerId = 12, FirstName = "John", LastName = "Petersen", Email = "johnvpetersen@gmail.com" },
                new CustomerModel() { CustomerId = 12, FirstName = "Brian", LastName = "Noyes", Email = "briannoyes@gmail.com" },
                new CustomerModel() { CustomerId = 14, FirstName = "Andrew", LastName = "Brust", Email = "andrewbrust@gmail.com" },
                new CustomerModel() { CustomerId = 15, FirstName = "Rocky", LastName = "Lhotka", Email = "rockylhotka@gmail.com" }
            };
        }
